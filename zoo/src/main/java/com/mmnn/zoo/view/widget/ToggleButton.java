...
public class ToggleButton extends View {
    private com.mmnn.zoo.view.rebound.SpringSystem springSystem;
    private com.mmnn.zoo.view.rebound.Spring spring;
    /** */
    ...
    com.mmnn.zoo.view.rebound.SimpleSpringListener springListener = new com.mmnn.zoo.view.rebound.SimpleSpringListener() {
        @Override
        public void onSpringUpdate(com.mmnn.zoo.view.rebound.Spring spring) {
    ...
    public void setup(AttributeSet attrs) {
        ...
        springSystem = com.mmnn.zoo.view.rebound.SpringSystem.create();
        spring = springSystem.createSpring();
        spring.setSpringConfig(com.mmnn.zoo.view.rebound.SpringConfig.fromOrigamiTensionAndFriction(50, 7));
    ...
    private void calculateEffect(final double value) {
        final float mapToggleX = (float) com.mmnn.zoo.view.rebound.SpringUtil.mapValueFromRangeToRange(value, 0, 1, spotMinX, spotMaxX);
        spotX = mapToggleX;

        float mapOffLineWidth = (float) com.mmnn.zoo.view.rebound.SpringUtil.mapValueFromRangeToRange(1 - value, 0, 1, 10, spotSize);
        ...
        int sb = (int) com.mmnn.zoo.view.rebound.SpringUtil.mapValueFromRangeToRange(1 - value, 0, 1, fb, tb);
        int sr = (int) com.mmnn.zoo.view.rebound.SpringUtil.mapValueFromRangeToRange(1 - value, 0, 1, fr, tr);
        int sg = (int) com.mmnn.zoo.view.rebound.SpringUtil.mapValueFromRangeToRange(1 - value, 0, 1, fg, tg);
